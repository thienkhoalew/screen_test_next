...
import { MOCK_VEHICLES, VEHICLE_FOOTER_DATA } from "@/data/vehicles";
                ...
                <Table className="border-collapse border border-gray-300 min-w-max">
                    ...
                    <TableBody>
                        ...
                        <TableRow className="bg-yellow-50 font-medium h-20">
                            ...
                            {DATES.map((day) => {
                                const count = VEHICLE_FOOTER_DATA.unassignedWorkCount[day as keyof typeof VEHICLE_FOOTER_DATA.unassignedWorkCount];
                                return (
                        ...
                        <TableRow className="bg-blue-50 font-medium h-20">
                            ...
                            {DATES.map((day) => {
                                const tasks = VEHICLE_FOOTER_DATA.unassignedWorkNumber[day as keyof typeof VEHICLE_FOOTER_DATA.unassignedWorkNumber];
                                return (
                        ...
                        <TableRow className="bg-green-50 font-medium">
                            ...
                            {DATES.map((day) => {
                                const count = VEHICLE_FOOTER_DATA.scanExpectation[day as keyof typeof VEHICLE_FOOTER_DATA.scanExpectation];
                                return (
