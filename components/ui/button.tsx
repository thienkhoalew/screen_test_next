  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        red: "w-32 py-2 bg-[#FB2C36B2] hover:bg-red-500 text-white rounded-lg shadow text-lg font-medium",
        yellow: "w-32 py-2 bg-[#FFC000] hover:bg-yellow-500 text-black rounded-lg shadow text-lg font-medium",
        ...
        orange: "bg-[#E8924F] text-white flex items-center h-8 px-4 text-[10px] font-bold",
        gray: "bg-[#536675] text-white flex items-center h-8 px-4 text-[10px] font-bold",
        grayBordered: "bg-[#D1D5DC] text-gray-700 border border-gray-400 hover:bg-gray-300 h-8 px-4 text-sm font-medium rounded-md",
      },
      size: {
